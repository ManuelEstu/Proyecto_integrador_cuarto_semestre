...
public class Ver_ordenes extends javax.swing.JFrame {
    ...
    private void cargarOrdenes(String doc, String tip) {
        ...
        if (lista.isEmpty() && tip != null && !tip.trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "No se encontró ninguna orden de producción de tipo " + tip + " con el documento " + doc, "Sin resultados", JOptionPane.INFORMATION_MESSAGE);
