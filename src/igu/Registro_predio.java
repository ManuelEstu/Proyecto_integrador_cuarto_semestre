...
import logica.ControladorPredio; 
...
public class Registro_predio extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Registro_predio
     */
    ...
    private void initComponents() {
        ...
        Txt_num_ICA_lugar = new javax.swing.JTextField();
        jLabel5 = new javax.swing.JLabel();
        Txt_extencion = new javax.swing.JTextField();
        ...
        jLabel1.setText("Registro de predios");
        ...
        jLabel4.setText("Num. Registro ICA lugar de producción asociado:");

        jLabel5.setText("Extención (hectáreas):");
        ...
        Txt_documento_dueno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Txt_documento_duenoActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(Txt_vereda, javax.swing.GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
                                    .addComponent(Txt_numero_predial)
                                    .addComponent(Txt_num_ICA_lugar)
                                    .addComponent(Txt_extencion)))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(Txt_documento_dueno, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(163, 163, 163)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(Txt_num_ICA_lugar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(Txt_extencion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
    ...
    private ControladorPredio control = new ControladorPredio();
    private void Btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_registrarActionPerformed
        ...
        String numICALugar = Txt_num_ICA_lugar.getText().trim();
        String extencion = Txt_extencion.getText().trim();
    ...
    private void Txt_documento_duenoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Txt_documento_duenoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Txt_documento_duenoActionPerformed
    
     private void limpiarCampos() {
        Txt_numero_predial.setText("");
        Txt_nombre.setText("");
        Txt_num_ICA_lugar.setText("");
        Txt_extencion.setText(""); 
        Txt_vereda.setText(""); 
    }
    ...
    private boolean validarCamposVacios() {
        ...
        if (Txt_numero_predial.getText().trim().isEmpty() ||
            ...
            Txt_num_ICA_lugar.getText().trim().isEmpty() ||
            Txt_extencion.getText().trim().isEmpty() ||
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Registro_predio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Registro_predio().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField Txt_extencion;
    private javax.swing.JTextField Txt_nombre;
    private javax.swing.JTextField Txt_num_ICA_lugar;
