...
import persistencia.DaoInformeVisTec;

/**
 * Clase Controladora (Capa de Negocio) para gestionar las operaciones 
 * relacionadas con la búsqueda de Informes de Visita Técnica.
 * * Se encarga de la validación de la entrada y la coordinación con la capa DAO.
 */
public class ControladorInformeVisTec {

    // Instancia del DAO para interactuar con la base de datos
    private final DaoInformeVisTec daoInformeVisTec;
     ...
     */
    public ControladorInformeVisTec() {
        this.daoInformeVisTec = new DaoInformeVisTec();
    }
     ...
     */
    public Optional<InformeVisTec> buscarUltimoInforme(String icaNumber) {
        ...
        try {
            ...
            return daoInformeVisTec.obtenerUltimoInformePorIca(icaLimpio);
        } catch (Exception e) {
