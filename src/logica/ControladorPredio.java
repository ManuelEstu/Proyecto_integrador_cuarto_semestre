...
public class ControladorPredio {
    ...
    public String validarRegistro(String numeroPredial, String nombre, String numICALugar,
        ...
        int nuevoRegistroICA = DaoPredio.obtenerSiguienteICA();
        ...
        boolean exitoGuardado = DaoPredio.guardarLugar(
            nuevoRegistroICA,
            numeroPredial, 
            nombre, 
            numICALugar,
    ...
    public String validarNumeros(String numeroPredial, String extencion, String documentoDueno) {
        String preStr = String.valueOf(numeroPredial);
        String telEmStr = String.valueOf(extencion);
        ...
        if (!preStr.matches("\\d+") || !telEmStr.matches("\\d+") || !docDuenoStr.matches("\\d+")) {
            return "Los campos numéricos (Predial, extencion, Documento) solo deben contener dígitos.";
        }
